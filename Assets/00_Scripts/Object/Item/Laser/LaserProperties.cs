...
namespace Lightbug.LaserMachine
{
    ...
    {
        [Header("Collision Detection")] public LayerMask m_layerMask;
        ...
        [Header("Shape")] public float m_rayWidth = 0.01f;
        ...
        [Header("Rotation")] public bool m_rotate = true;
        public bool m_rotateClockwise = true;
        public float m_rotationSpeed = 20;

        [Header("Intermittentency")] public bool m_intermittent = false;
